...
public class MatrixReader {
   ...
   */
  public static Matrix<BigFraction, Q> read(InputStream in)
      throws MatrixFormatException, IOException {
    ...
    try {
        ...
        try {
          ...
          if (tokenizer.countTokens() != 2) {
            throw new MatrixFormatException(
                "could not read the rows/columns spec");
          }
      ...
      matrix = Matrix.dense(new Q(), rows, cols);
